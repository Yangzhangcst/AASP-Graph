...
if display, imwrite(img,fullfile(out_path, [only_name '.bmp'])); end
...
if display == 1, imwrite(imgMarkup,OutImgName_1); end
...
[imgMasks,segOutline,imgMarkup]=segoutput(disp_img,label_img);
if display == 1, imwrite(imgMarkup,OutImgName_2); end
